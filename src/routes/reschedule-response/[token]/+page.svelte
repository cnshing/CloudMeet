...
<div class="min-h-screen bg-background flex flex-col items-center justify-center p-4">
	{#if success === 'accepted'}
		...
		<div class="bg-surface border border-border rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
			...
			<p class="text-muted-foreground mb-6">Your meeting has been confirmed for the new time. A calendar update has been sent to your email.</p>
	...
	{:else if data.alreadyResponded}
		...
		<div class="bg-surface border border-border rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
			...
			<h1 class="text-2xl font-semibold text-foreground mb-2">Already Responded</h1>
			<p class="text-muted-foreground">This reschedule request has already been {data.proposal?.status}.</p>
		</div>
